...
const Notifications = () => {
    ...
    const loadData = () => {
        Axios.get("http://localhost:3001/api/notification").then(response=>{
        ...
        Axios.get("http://localhost:3001/api/notification/type").then(response=>{
    ...
    const handleSend = () => {
        ...
        Axios.post("http://localhost:3001/api/notification", newMessage).then(response=>{
